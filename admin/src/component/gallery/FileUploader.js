    ...
    render() {
        return (
            <div className='gallery'>
                            ...
                            <div key={index} className='img-box' style={{ height: '200px', width: '200px' }}>
                                ...
                                <div>
                                    ...
                                    <Tooltip title='لینک و اولویت'>
                                        <IconButton onClick={() => this.setState({ linkDialog: true, current: index })} style={{ color: (file.link ? "#04f080" : "#828282")}} className='link-btn animated flash'>
                                            <LinkedCameraIcon />
                                        </IconButton>
                                    </Tooltip>
                                </div>}
                ...
                >
                    <DialogTitle id="alert-dialog-slide-title">تغییر لینک و اولویت نمایش</DialogTitle>
                    <DialogContent>
