...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `gender` enum('male','female') COLLATE utf8_persian_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
...
INSERT INTO `oauth_access_tokens` (`id`, `user_id`, `client_id`, `name`, `scopes`, `revoked`, `created_at`, `updated_at`, `expires_at`) VALUES
	...
	('c81822fda07a6fead6f66fb4e02ec71903ef63e48bdbb6bc0db838104e63cd8c5618438f7f3b9cb3', 1, 10, 'Token Name', '[]', 0, '2020-01-19 09:25:58', '2020-01-19 09:25:58', '2021-01-19 09:25:58'),
...
INSERT INTO `permission` (`key`, `title`, `url`, `method`, `parent`, `created_at`, `updated_at`) VALUES
	...
	('member_index', 'مدیریت', '/api/backend/members', 'GET', 'member', '2020-01-19 12:44:30', '2020-01-19 12:44:30'),
	('member_show', 'نمایش', '/api/backend/members/{id}', 'GET', 'member', '2020-01-19 12:44:30', '2020-01-19 12:44:30'),
	('member_store', 'ذخیره سازی', '/api/backend/members', 'POST', 'member', '2020-01-19 12:44:30', '2020-01-19 12:44:30'),
	('member_update', 'به روز رسانی', '/api/backend/members/{id}', 'PUT', 'member', '2020-01-19 12:44:30', '2020-01-19 12:44:30'),
	('permission_index', 'مدیریت', '/api/backend/users/permissions', 'GET', 'permission', '2020-01-10 21:16:08', '2020-01-10 21:16:08'),
	('region_index', 'مدیریت', '/api/backend/regions', 'GET', 'region', '2020-01-19 08:40:27', '2020-01-19 08:40:27'),
	('region_show', 'نمایش', '/api/backend/regions/{id}', 'GET', 'region', '2020-01-19 08:40:27', '2020-01-19 08:40:27'),
	('region_store', 'ذخیره سازی', '/api/backend/regions', 'POST', 'region', '2020-01-19 08:40:27', '2020-01-19 08:40:27'),
	('region_update', 'به روز رسانی', '/api/backend/regions/{id}', 'PUT', 'region', '2020-01-19 08:40:27', '2020-01-19 08:40:27'),
	...
	('session_category_index', 'مدیریت', '/api/backend/session/categories', 'GET', 'session_category', '2020-01-19 09:15:24', '2020-01-19 09:15:24'),
	('session_category_show', 'نمایش', '/api/backend/session/categories/{id}', 'GET', 'session_category', '2020-01-19 09:15:24', '2020-01-19 09:15:24'),
	('session_category_store', 'ذخیره سازی', '/api/backend/session/categories', 'POST', 'session_category', '2020-01-19 09:15:24', '2020-01-19 09:15:24'),
	('session_category_update', 'به روز رسانی', '/api/backend/session/categories/{id}', 'PUT', 'session_category', '2020-01-19 09:15:24', '2020-01-19 09:15:24'),
	('session_index', 'مدیریت', '/api/backend/session', 'GET', 'session', '2020-01-19 09:04:34', '2020-01-19 09:04:34'),
	('session_show', 'نمایش', '/api/backend/session/{id}', 'GET', 'session', '2020-01-19 09:04:34', '2020-01-19 09:04:34'),
	('session_store', 'ذخیره سازی', '/api/backend/session', 'POST', 'session', '2020-01-19 09:04:34', '2020-01-19 09:04:34'),
	('session_update', 'به روز رسانی', '/api/backend/session/{id}', 'PUT', 'session', '2020-01-19 09:04:34', '2020-01-19 09:04:34'),
...
-- Dumping data for table heydaritayeb.permission_role: ~106 rows (approximately)
...
INSERT INTO `permission_role` (`role_key`, `permission_key`) VALUES
	...
	('programmer', 'session_category_index'),
	('programmer', 'session_category_show'),
	('programmer', 'session_category_store'),
	('programmer', 'session_category_update'),
	('programmer', 'session_index'),
	('programmer', 'session_show'),
	('programmer', 'session_store'),
	('programmer', 'session_update'),
...
-- Dumping data for table heydaritayeb.ticket: ~2 rows (approximately)
...
-- Dumping data for table heydaritayeb.ticket_conversation: ~2 rows (approximately)
